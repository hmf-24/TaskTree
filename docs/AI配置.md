...
如果你在使用 AI 分析、AI 智能创建、文章摘要生成等功能时遇到"AI 对话失败"或"未配置大模型服务"的错误，说明需要配置 LLM API Key。
...
**【ReadHub 模块】**
6. **AI 按需摘要**：在查询资讯时，由 LLM 零闲置耗损地实时生成文章精华摘要
7. **WeweRSS 智能挂载**：通过自然语言意图，让 AI 主动去 WeweRSS 搜索并挂载新的微信公众号爬虫节点
8. **FTS5 记忆检索**：借助 AI 和全文检索引擎，在毫秒级召回并总结数十万字的历史资讯
...
如果遇到其他问题，请查看：
- 系统整体架构：`docs/architecture/系统整体架构.md`
- 技术方案：`docs/tech/技术_解决方案.md`
- 开发记录：`docs/开发记录.md`
