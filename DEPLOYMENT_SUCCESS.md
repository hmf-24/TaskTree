...
### 后端日志
```
[2026-04-24 07:14:41 +0000] [10] [INFO] Started server process [10]
[2026-04-24 07:14:41 +0000] [10] [INFO] Waiting for application startup.
[2026-04-24 07:14:41 +0000] [10] [INFO] Application startup complete.
127.0.0.1:39266 - "GET /health HTTP/1.1" 200
```

### 前端日志
```
2026/04/24 15:14:45 [notice] 1#1: start worker process 32
2026/04/24 15:14:45 [notice] 1#1: start worker process 33
...
172.19.0.1 - - [24/Apr/2026:15:15:14 +0800] "GET /project/3 HTTP/1.1" 200 467
```
...
所有服务都正常运行，可以开始使用应用了。如有任何问题，请参考上述文档或查看日志。
